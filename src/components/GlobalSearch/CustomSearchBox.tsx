    ...
    >
      <div className="relative">
        <input
          ...
          className="h-[74px] w-full rounded-lg bg-white pl-[60px] pr-5 text-black outline-none dark:bg-black dark:text-white"
        />
        <span className="absolute left-0 top-0 flex h-[74px] w-[52px] items-center justify-center text-black dark:text-white">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
